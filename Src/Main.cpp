...
int main()
{
    ...
    learning.testNeuralNetwork();
    learning.getCharacter();
...
//        double threeOut[2] = {1,0};
//        const double myTestFour[patternSize] = {0, 0};
//        double fourOut[2] = {0,1};
...
//        cout << myTestOne[0] << " " << myTestOne[1] << " | " << myNeuralNetwork->getOutput()[1] << endl;
//        myNeuralNetwork->feedForward((double *)&myTestTwo);
//        cout << myTestTwo[0] << " " << myTestTwo[1] << " | " << myNeuralNetwork->getOutput()[1] << endl;
//        myNeuralNetwork->feedForward((double *)&myTestThree);
//        cout << myTestThree[0] << " " << myTestThree[1] << " | " << myNeuralNetwork->getOutput()[1] << endl;
//        myNeuralNetwork->feedForward((double *)&myTestFour);
//        cout << myTestFour[0] << " " << myTestFour[1] << " | " << myNeuralNetwork->getOutput()[1] << endl;
